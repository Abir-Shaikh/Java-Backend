...
public class Project4__MovieLibraryFilter {
    public static void main(String[] args) {
        List<Movie> movies = List.of(
                new Movie("Interstellar" , "Sci-fi" , 10),
                new Movie("Inception", "Sci-Fi", 9.5),
                new Movie("The Dark Knight", "Action", 9.7),
        ...
        //System.out.println(movies.stream().map(Movie::getGenre).distinct().collect(Collectors.toList()));

        System.out.println("The movies are : " + movies.stream().filter(x -> x.getGenre().equalsIgnoreCase("Action"))
